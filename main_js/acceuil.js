...
formulaire.addEventListener("click", function(event){
    ...
    if(option1.selected==false && option2.selected==false){
        ...
        error_champ.innerHTML="<div class='alert alert-danger'>Veuiller selectionner une option</div>";
    }
    else if(login.value==""){
        login.classList.add('alert', 'alert-danger');
       error_champ.innerHTML="<div class='alert alert-danger'>Veuiller saisir votre login</div>";
    }
    else if(pass.value==""){
        pass.classList.add('alert', 'alert-danger');
        error_champ.innerHTML="<div class='alert alert-danger'>Veuiller saisir votre mot de pass</div>";
    }
